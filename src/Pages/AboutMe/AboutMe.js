...
const AboutMe = () => {
    return (
        <section>
            <Box sx={{ flexGrow: 1 }}>
                <Grid container pt='4rem' pr='4rem' pl='6rem'  columns={{ xs: 4, sm: 8, md: 12 }}>
                    <Grid container spacing={2} columns={{ xs: 4, sm: 8, md: 12 }}>
                        <Grid xs={8}>
                            ...
                            <br />
                            <Typography pl="1rem" variant="h6" component="h2">
                                <span style={{ fontWeight: 'bold' }}>Hi,I'm Jonaeath Hossin</span><br />
                                I am an Engineer and also I'm a full-stack web developer with a passion for web design. I enjoy developing simple, clean, and slick websites that provide real value to the end user.From July 2022 till the present, I am working as a web Developer at Dream IT Ltd.
                            </Typography>
                        </Grid>
                        <Grid xs={4} sx={{ textAlign: 'center', pt: '2rem' }}>
                            <Typography className='animationOne' variant="h1" component="h2">2</Typography>
                            <Typography className='animationTwo' variant="h3" component="h2">Years of Experiance</Typography>
                        </Grid>
                    </Grid>
